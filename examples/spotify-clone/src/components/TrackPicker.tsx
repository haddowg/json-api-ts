...
/**
 * A catalogue track picker: a search box driving `filter[q]` over a typed `reads.tracks.list`
 * (with `include: ['album']` so a row can link to its album), each row an "Add" button. The
 * search reuses the same typed read surface the rest of the app does.
 */
